...
public class Hemeroteca extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        ((MainActivity)getActivity()).setTitleActionBar(getString(R.string.bar_hemeroteca));
        // Usar un administrador para LinearLayout
        listItems = new ArrayList<>();
        RecyclerItem recyclerItem = new RecyclerItem();
        recyclerItem.titulo = "ABRIL 2016";
        recyclerItem.img = "";
        listItems.add(recyclerItem);
        RecyclerItem recyclerItem2 = new RecyclerItem();
        recyclerItem2.titulo = "MARZO 2016";
        recyclerItem2.img = "";
        listItems.add(recyclerItem2);
        RecyclerItem recyclerItem3 = new RecyclerItem();
        recyclerItem3.titulo = "FEBRERO 2016";
        recyclerItem3.img = "";
        listItems.add(recyclerItem3);
        RecyclerItem recyclerItem4 = new RecyclerItem();
        recyclerItem4.titulo = "ENERO 2016";
        recyclerItem4.img = "";
        listItems.add(recyclerItem4);
        recyclerView.setAdapter(new RecyclerAdapter(listItems, 0));
